...
1. "sex" is something physical. for example the sex of any animal (including humans) might be about:
...
2. i think i'd say "gender" is the word we eventually invented for the non-physical things we associate with sex. it's a cultural concept. for example the gender of a human might be about:
...
1. all of the ideas are different from each other and don't necessarily align.
2. many of the ideas don't exactly work on their own. especially the things you wouldn't actually know about someone, even though you do know their gender. so they can't be what gender is.
3. also, none of the ideas has a specific number of options. there is no limit to the ways people ultimately are all different from each other.
